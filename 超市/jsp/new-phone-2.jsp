...
<div class="content content-use">
	...
	<div class="login" id="oLogin">
		<div class="login-form clearfix">
			...
			<form action="/userCenter/setNewMobile" method="post" id="secondForm">
				<input type="hidden" name="mmm" value="${mmobile}"/>
		        <p>
		        	<span class="name-form">新手机号码：</span>
		        ...
		        <p>
		        	...
		        	<input type="submit" value="确定修改" class="s-btn btn-login">
		        </p>
		    </form>
		</div>
	</div>
...
<script src="http://ui.91jinrong.com/cs/script/checkcodeUpdateMobile.js"></script>
</body>
</html>
